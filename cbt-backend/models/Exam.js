...
const examSchema = new mongoose.Schema({
    ...
    // --- REMOVED: Individual 'subject' field ---
    // subject: {
    //     type: String,
    //     required: true,
    //     trim: true
    ...
    subjectsIncluded: [{ // Array of subjects that make up this unit exam
        subjectId: {
            type: mongoose.Schema.Types.ObjectId,
            ref: 'Subject', // Reference to the new Subject model
            required: true,
        },
        subjectName: { // Storing name directly for easier display/lookup (denormalized)
            type: String,
            required: true,
            trim: true,
        },
        numberOfQuestions: { // Number of questions to pull from this subject for this exam
            type: Number,
            required: true,
            min: 0,
            default: 0,
